...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      <h3 class="page-header text-primary"><i class="fa fa-graduation-cap"></i> Atribuir Professor</h3>
        <b>Turma: </b> Turma: ${disciplina.turma.serie} / ${disciplina.turma.nome} / ${disciplina.turma.turno} <br>
        <b>Disciplina: </b> ${disciplina.nome } / <b>Descrição: </b> ${disciplina.descricao } <br>
        <hr>
        <form class="form-horizontal" action="<c:url value="/disciplina/atribuirProfessor"/>" method="post">
