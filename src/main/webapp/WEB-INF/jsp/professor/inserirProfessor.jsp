...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      <h3 class="page-header text-primary"><i class="fa fa-graduation-cap"></i> Adicionar Professor</h3>
      <h5><b>O professor que você tentou atribuir à disciplina ainda não está cadastrado, cadastre-o através do formulário abaixo!</b></h5>
      <form class="form-horizontal" action="<c:url value="/professor/inserirProfessor"/>" method="post" id="formAddProfessor">
      	<div class="form-group">
      		<label for="nome" class="col-sm-2 control-label"> Nome *</label>
      		<div class="col-sm-10">
      			<input type="text" class="form-control" id="nome" name="professor.nome" required/>
      		</div>
      	</div>
      	<div class="form-group">
      		<label for="email" class="col-sm-2 control-label"> Email *</label>
      		<div class="col-sm-10">
            	<input type="email" class="form-control" id="email" name="professor.email" required/>
            </div>
      	</div>	
      	<div class="pull-right">
      		<input type="hidden" value="${turma.id }" name="idDaTurma"/>
      		<button type="submit" class="btn btn-success" form="formAddProfessor">Adicionar Professor</button>
      	</div>
      </form>  
    </div>
    <div class="col-sm-2 sidenav">
...
<footer class="container-fluid text-center">
  <p><b>LabEaSII - IsCool 2016 Todos os direitos reservados</b></p>
</footer>
