...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      <h3 class="page-header text-primary"><i class="fa fa-user"></i> Adicionar Aluno</h3>
        <b>Turma: </b> Turma: ${turma.serie} / ${turma.nome} / ${turma.turno} <br>
        <hr>
        <form role="form" class="form-horizontal" id="formAddAluno" action="<c:url value="/aluno/inserirAluno"/>" method="post">
        	<h5><b>Adicionar Aluno</b></h5>
        	<div class="form-group">
        		<label for="nome" class="col-sm-2 control-label"> Nome * </label>
        		<div class="col-sm-10">
        			<input type="text" class="form-control" id="nome" name="aluno.nome" required/>
        		</div>
        	</div>
        	<div class="form-group">
        		<label for="email" class="col-sm-2 control-label"> Email * </label>
        		<div class="col-sm-10">
        			<input type="email" class="form-control" id="cnpj" name="aluno.email" required/>
        		</div>
        	</div>
        	<div class="form-group">
        		<label for="text" class="col-sm-2 control-label"> CPF do responsável * </label>
        		<div class="col-sm-10">
        			<input type="text" class="form-control" id="cpf" name="aluno.cpfResponsavel" required/>
        		</div>
        	</div>
        ...
        <br><br><hr>
        <form action="<c:url value="/aluno/importarArquivoCSV"/>" method="post" enctype="multipart/form-data">
        	<h5><b>Importar Alunos</b></h5>
        	<label>Importe todos os alunos da turma de uma só vez através de um arquivo CSV</label>
        	<input type="file" name="uploadedFile" required>
        	<input type="hidden" name="idDaTurma" value="${turma.id }" />
        	<div class="form-group" >
        		<div class="pull-right">
                	<button type="submit" class="btn btn-success">Importar Arquivo <i class="fa fa-file-o"></i></button>
