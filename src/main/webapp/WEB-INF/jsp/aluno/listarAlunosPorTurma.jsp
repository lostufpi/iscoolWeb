...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      <h3 class="page-header text-primary"><i class="fa fa-users"></i> Participantes</h3>
        	...
        	<div class="col-lg-6 col-md-6">
		        <div class="panel panel-default">
		          <div class="panel-heading">
		            <div class="row">
		              <div class="col-xs-3">
		                	<img src="<gravatar:image email="${aluno.email }" size="90"/>" alt="Gravatar" title="${aluno.nome }"/>
		              </div>
		              <div class="col-xs-9 text-right">
		              	<form role="form" action="<c:url value="/aluno/${aluno.id}"/>" method="post" id="deleteParticipante">
							<button type = "submit" class="btn btn-inverse btn-default" form="deleteParticipante" name="_method" value="DELETE">
		                		<i class="fa fa-trash" aria-hidden="true"></i>
		                	</button>
						</form>
		                <div>
		                	<h5><b>${aluno.nome }</b></h5>
		                	<h6><b>${aluno.email }</b></h6>
		                </div>
		              </div>
		            </div>
		          </div>
